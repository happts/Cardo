...
class UIAlertUtils {
    ...
    class func alertControllerDistructive(ViewController:UIViewController, message: String ,handler:((UIAlertAction) -> Void)? = nil){
        let alertController = UIAlertController(title: "", message: message, preferredStyle: .alert)
        let deleteAction = UIAlertAction(title: "删除", style: .destructive, handler: handler)
